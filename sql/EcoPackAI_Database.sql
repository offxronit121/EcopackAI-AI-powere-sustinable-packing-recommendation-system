...
CREATE TABLE materials (
    ...
    biodegradability_score SMALLINT NOT NULL CHECK (biodegradability_score BETWEEN 0 AND 10),
    recyclability_pct NUMERIC(5,2) NOT NULL CHECK (recyclability_pct BETWEEN 0 AND 100),
...
('M001','Recycled Paper',45,5.0,1.2,9,85,12,'Paper'),
('M002','Bioplastic',60,6.5,2.1,7,60,18,'Plastic');

INSERT INTO products VALUES
('P001','Mobile Charger','Electronics',200,300,799,'Medium','Low','Low',365,'Box','Recycled Paper');
